...
public class SQLHelper extends SQLiteOpenHelper {
    ...
    /** STATIC É APLICADO PARA ATRIBUTOS E MÉTODOS QUE SERÃO UTILIZADOS MUITAS VEZES **/
    ...
    */
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE tbl_livro" +
                ...
                "descricao TEXT," +
                "foto TEXT," +
                "created_date DATETIME," + "FOREIGN KEY (cod_usuario) REFERENCES tbl_usuario(cod_usuario))");
