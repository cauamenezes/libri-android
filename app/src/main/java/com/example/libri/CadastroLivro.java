            ...
            AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.salvar, (dialog1, which)->{
                        ...
                        boolean cadastroLivro =
                                SQLHelper.getInstance(CadastroLivro.this).addBook(1 , titulo, descricao, foto, created_date);

                        if(cadastroLivro) {

                            Toast.makeText(this, "CADASTRO REALIZADO COM SUCESSO!", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(this, "HOUVE UM ERRO AO REALIZAR O CADASTRO DO LIVRO!", Toast.LENGTH_SHORT).show();
                        }
